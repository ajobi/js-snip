...
describe('snipByJS', () => {
  ...
  it('Snips on negative max lines', () => {
    cy.get('[data-cy=paragraph]').then(($paragraph) => {
      ...
      snipByJS(paragraph, { fullText: paragraph.textContent, maxLines: -1 })
  ...
  it('Snips on zero max lines', () => {
    cy.get('[data-cy=paragraph]').then(($paragraph) => {
      const paragraph = $paragraph.get()[0]
      snipByJS(paragraph, { fullText: paragraph.textContent, maxLines: 0 })
  ...
  it('Snips on 2 max lines', () => {
    cy.get('[data-cy=paragraph]').then(($paragraph) => {
      const paragraph = $paragraph.get()[0]
      snipByJS(paragraph, { fullText: paragraph.textContent, maxLines: 2 })
  ...
  it('Does not snip on 10 max lines', () => {
    cy.get('[data-cy=paragraph]').then(($paragraph) => {
      const paragraph = $paragraph.get()[0]
      snipByJS(paragraph, { fullText: paragraph.textContent, maxLines: 10 })
